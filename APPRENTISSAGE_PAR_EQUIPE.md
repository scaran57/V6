...
**Exemple** :
```bash
curl -X POST https://match-forecast-77.preview.emergentagent.com/api/learn \
  -F "predicted=3-0" \
  -F "real=3-0" \
...
**Exemple** :
```bash
curl "https://match-forecast-77.preview.emergentagent.com/api/teams/Ajax%20Amsterdam"
```
