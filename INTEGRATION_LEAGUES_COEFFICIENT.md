...
```bash
curl https://score-oracle-11.preview.emergentagent.com/api/admin/league/list
# Attendu: 8 ligues
```

### Test 2: Coefficient avec Fallback
```bash
curl "https://score-oracle-11.preview.emergentagent.com/api/league/team-coeff?team=Real%20Madrid&league=ChampionsLeague"
# Attendu: coefficient ~1.30, source: LaLiga
```

### Test 3: Bonus Européen
```bash
curl "https://score-oracle-11.preview.emergentagent.com/api/league/team-coeff?team=Galatasaray&league=ChampionsLeague"
