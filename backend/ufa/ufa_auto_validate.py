...
TEAM_MAP_FILE = Path("/app/data/team_map.json")  # generated by generate_team_map.py
LOG_FILE = Path("/app/logs/ufa_auto_train.log")
# Choose either TRAIN_API_URL (preferred) or TRAIN_SCRIPT
TRAIN_API_URL = os.environ.get("UFA_TRAIN_API", "http://localhost:8001/api/learn?auto=true")
TRAIN_SCRIPT = os.environ.get("UFA_TRAIN_SCRIPT", "/app/backend/ufa/training/train_ufa_model.py")
# thresholds
FUZZY_THRESHOLD = 75
# allowed goals range (sanity)
MIN_GOAL = 0
MAX_GOAL = 9
# duplicate match detection window in days
