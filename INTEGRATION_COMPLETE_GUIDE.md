...
1. **Accédez à l'application**
   ```
   https://betanalyst-10.preview.emergentagent.com/
   ```
...
```bash
# Upload et analyse
curl -X POST "https://betanalyst-10.preview.emergentagent.com/api/unified/analyze" \
  -F "file=@/path/to/image.jpg" \
  -F "persist_cache=true" \
  | jq '.'

# Health check
curl "https://betanalyst-10.preview.emergentagent.com/api/unified/health" | jq '.'
```
...
**URL :** https://betanalyst-10.preview.emergentagent.com/
...
**URL de l'application :** https://betanalyst-10.preview.emergentagent.com/
