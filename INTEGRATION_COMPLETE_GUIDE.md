...
1. **Accédez à l'application**
   ```
   https://match-forecast-77.preview.emergentagent.com/
   ```
...
```bash
# Upload et analyse
curl -X POST "https://match-forecast-77.preview.emergentagent.com/api/unified/analyze" \
  -F "file=@/path/to/image.jpg" \
  -F "persist_cache=true" \
  | jq '.'

# Health check
curl "https://match-forecast-77.preview.emergentagent.com/api/unified/health" | jq '.'
```
...
**URL :** https://match-forecast-77.preview.emergentagent.com/
...
**URL de l'application :** https://match-forecast-77.preview.emergentagent.com/
