...
```bash
# Vérifier le statut
curl https://match-forecast-77.preview.emergentagent.com/api/admin/league/scheduler-status

# Déclencher mise à jour manuelle
curl -X POST https://match-forecast-77.preview.emergentagent.com/api/admin/league/trigger-update
```
...
# Status du scheduler
curl https://match-forecast-77.preview.emergentagent.com/api/admin/league/scheduler-status | python3 -m json.tool

# Vérifier l'apprentissage
curl https://match-forecast-77.preview.emergentagent.com/api/diff

# Vérifier le cache
curl https://match-forecast-77.preview.emergentagent.com/api/matches/memory
```
...
curl -X POST https://match-forecast-77.preview.emergentagent.com/api/admin/league/clear-cache
